...
FROM (VALUES
    ...
    ('liabilities_and_equity', 'LiabilitiesAndStockholdersEquity',                              1, 'USD', 'instant'),
    ...
    ('equity_total',         'StockholdersEquityIncludingPortionAttributableToNoncontrollingInterest', 1, 'USD', 'instant'),
